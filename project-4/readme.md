...
| 1-layer TR 2AH 64 we 512 from previous 1 AH (uniform distribution (and generator to the previous one))  |   22824514  (33994432 frozen)       |         50k steps 18.11

100k steps 18.42  

150k steps 18.44 still training       |
