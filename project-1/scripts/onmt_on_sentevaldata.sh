MODEL=transformer.en-de+fi

BASE=$HOME/Github/MultiInt/project-1/
ONMT=$BASE/opennmtsrc
SCRIPTS_DIR=$BASE/scripts

MODEL_FILE=$BASE/models/$MODEL.model_step_200000.pt
...
for TASK in ${SENTEVAL_TASKS[*]}; do
    ...
    OUTPUT_FILE=$BASE/outputs/$MODEL.$TASK.tran
    REPRS_FILE=$BASE/representations/$MODEL.$TASK.reprs.pickle
