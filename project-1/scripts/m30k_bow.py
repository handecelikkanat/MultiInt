...
PATH_TO_VEC = 'm30k/vectors_m30k.txt'
...
codes = codecs.open("./m30k/codecs40k", encoding='utf-8')
vocabulary = codecs.open("./m30k/bpe_vocab.en", encoding='utf-8')
vocabulary = read_vocabulary(vocabulary, threshold=20)
bpe = BPE(codes=codes, vocab=vocabulary)
